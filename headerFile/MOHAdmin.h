...
public:
    ...
    // Manage User Account
    void createUser(const string& uUsername, const string& uName,const string& uPassword, const string& uResidence, const int& uPhoneNo, time_t loginTime);
    bool isUserUsernameTaken(const std::string &usernameToCheck);
    bool userLogin(const string& username, const string& password);
    User getUserInfo(const string& username);
    void updateUserInformation(const string& username, const string& newUsername, const string& newName,const string& newPassword, const string& newResidence, const int newPhoneNo);
    ...
    bool isDocUsernameTaken(const std::string &usernameToCheck);
